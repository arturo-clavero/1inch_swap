...
const { ethHTLC, scrollHTLC } = require('../controllers/relayer'); //relayers wallet with private key to sign
const {ethContract, scrollContract} = require('../controllers/contract'); // user pays with his wallet
